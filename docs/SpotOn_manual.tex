...
\textsc{\large An updated version of this manual is online on}\\[0.2cm] % Minor heading such as course title
...
\includegraphics[width=8cm]{../logo/spoton_logo_square.png}\\[0.3cm] % Include a department/university logo - this will require the graphicx package
